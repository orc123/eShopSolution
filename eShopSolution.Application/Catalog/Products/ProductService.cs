...
namespace eShopSolution.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public async Task<ApiResult<PagedResults<ProductVm>>> GetAllPaging(GetManageProductPagingRequest request)
        {
            ...
            var pagedResult = new PagedResults<ProductVm>()
            {
                TotalRecords = total,
                Items = data
            };
            return new ApiSuccessResult<PagedResults<ProductVm>>(pagedResult);
        }
        ...
        public async Task<PagedResults<ProductVm>> GetAllByCategoryId(string languageId, GetPublicProductPagingRequest request)
        {
            var query = from p in _context.Products
                        join pt in _context.ProductTranslations on p.Id equals pt.ProductId
                        join pic in _context.ProductInCategories on p.Id equals pic.ProductId
