...
namespace eShopSolution.Application.System.Users
{
    public class UserService : IUserService
    {
        ...
        public async Task<ApiResult<PagedResults<UserVm>>> GetUsersPaging(GetUserPagingRequest request)
        {
        ...
        public async Task<ApiResult<bool>> RoleAssign(Guid id, RoleAssignRequest request)
        {
            ...
            if (user == null)
            {
                return new ApiErrorResult<bool>("Không tìm thấy tài khoản với Id " + id);
            }
